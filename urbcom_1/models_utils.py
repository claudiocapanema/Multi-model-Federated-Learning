    ...
    try:
        ...
        if not get_from_volume:
            ...
            if dataset_name not in fds:
                ...
                print("entrou nee", fds)

                filename = f"/home/gustavo/PycharmProjects/Multi-model-Federated-Learning/system/datasets/{dataset_name}"
                ...
                if dataset_name not in fds and not os.path.isdir(filename):
                    ...
                    dataset = load_dataset(
                        {"EMNIST": "claudiogsc/emnist_balanced", "CIFAR10": "uoft-cs/cifar10", "MNIST": "ylecun/mnist",
                         ...
                         "Foursquare": "claudiogsc/foursquare-us-sequences-highlevel-200000-samples"}[
                            dataset_name])
                ...
                fds[dataset_name] = CustomFederatedDataset(
                    dataset={"EMNIST": "claudiogsc/emnist_balanced", "CIFAR10": "uoft-cs/cifar10", "MNIST": "ylecun/mnist",
                         ...
                         , "ImageNet10": "claudiogsc/ImageNet-10_household_objects", 'wikitext': 'claudiogsc/wikitext-Window-1-Words-3743',
                             "Foursquare": "claudiogsc/foursquare-us-sequences-highlevel-200000-samples"}[dataset_name],
