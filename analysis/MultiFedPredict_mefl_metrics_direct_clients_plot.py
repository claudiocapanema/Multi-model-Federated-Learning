...
def bar_general_metrics(df, base_dir, x, y_list, hue=None, style=None, ci=None, hue_order=None):
    ...
    fig.savefig(
        ...
        dpi=400)
    fig.savefig(
        """{}{}_general_metrics.pdf""".format(base_dir, y_list), bbox_inches='tight',
        dpi=400)
...
def bar_ps(df, base_dir, x, y_list, hue=None, style=None, ci=None, hue_order=None):
    ...
    bar_plot(df=df, base_dir=base_dir,
             ...
             hue="Dataset", title="Label shift", tipo="", y_lim=False, y_max=1.1, sci=True, palette=sns.color_palette(), padding=26)
