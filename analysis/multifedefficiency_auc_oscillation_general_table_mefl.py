...
def table(df, write_path, metrics, t=None):
    ...
    if t is not None:
        filename = """{}latex_round_auc_oscillation_general_{}_{}.txt""".format(write_path, [min(t), max(t)], metric)
    else:
        filename = """{}latex_auc_oscillation_general_{}.txt""".format(write_path, metric)
