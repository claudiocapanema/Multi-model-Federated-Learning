...
def read_data(dataset, idx, num_clients, alpha, is_train=True):
    if is_train:
        path = """./dataset/{}/clients_{}/alpha_{}/train/""".format(dataset, num_clients,alpha)
        train_data_dir = path
        ...
        path = """/dataset/{}/clients_{}/alpha_{}/test/""".format(dataset, num_clients, alpha)
        test_data_dir = path
