...
import numpy as np
import torch
from flcore.clients.clientmultifedyogi_global_model_eval import clientMultiFedYogiGlobalModelEval
...
class MultiFedYogiGlobalModelEval(Server):
    def __init__(self, args, times):
        super().__init__(args, times)

        # select slow clients
        self.set_slow_clients()
        self.set_clients(clientMultiFedYogiGlobalModelEval)
