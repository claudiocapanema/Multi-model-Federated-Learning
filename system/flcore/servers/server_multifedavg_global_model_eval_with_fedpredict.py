...
import time
import numpy as np
from flcore.clients.clientavg_global_model_eval_with_fedpredict import clientAVGGlobalModelEvalWithFedPredict
from flcore.servers.serverbase import Server
from threading import Thread


class MultiFedAvgGlobalModelEvalWithFedPredict(Server):
    def __init__(self, args, times):
        super().__init__(args, times)

        # select slow clients
        self.set_slow_clients()
        self.set_clients(clientAVGGlobalModelEvalWithFedPredict)
