...
import time
import numpy as np
from flcore.clients.clientkd_with_fedpredict import clientKDWithFedPredict
from flcore.servers.serverbase import Server
from threading import Thread
import sys


class MultiFedKDWithFedPredict(Server):
    def __init__(self, args, times):
        super().__init__(args, times)

        # select slow clients
        self.set_slow_clients()
        self.set_clients(clientKDWithFedPredict)
