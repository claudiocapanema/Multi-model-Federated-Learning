...
class MultiFedAvgWithMultiFedPredict(MultiFedAvgWithMultiFedPredictv0):
    ...
    def aggregate(self, results: list[tuple[NDArrays, int]], heterogeneity_degree: float,
        ...
        try:
            ...
            elif heterogeneity_degree > threshold[me]:
    ...
    #                         and self.ps[me] > 0.1 and (self.heterogeneity_degree[me] > 0.62 or "CONCEPT_DRIFT" in self.experiment_id) and self.increased_training_intensity[self.data_drift_model] < self.max_number_of_rounds_data_drift_adaptation:
    #                     data_drift_model = me
